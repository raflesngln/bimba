<table width="220" align="center" bgcolor="#EEEEEE" border="0" cellspacing="4" cellpadding="4">
  <tr>
    <td height="199" align="center"><a href="?page=foto"><img src="../gambar/guru/<?php echo $_SESSION['foto_guru'];  ?>" width="151" height="167" /></a></td>
  </tr>
    <tr>
    <td align="center"><?php echo strtoupper($_SESSION['nama-guru']);  ?></td>
  </tr>
  <tr>
    <td height="29"><div align="center"><a style="text-decoration:none; color:#000000;" href="proses-login-guru.php">Keluar</a></div></td>
  </tr>
  <tr>
